...
test('menu of edition of task', async({ page }) => {
  ...
  await expect(page.locator(`:nth-match(div[role="combobox"], 1)`)).toBeVisible()
  await expect(page.locator(`input[name="title"]`)).toBeVisbile()
  await expect(page.locator(`textarea[name="content"]`)).toBeVisible()
  await expect(page.locator(`:nth-match(div[role="combobox"], 2)`)).toBeVisible()
  await expect(page.locator(`:nth-match(div[role="combobox"], 3)`)).toBeVisible()
