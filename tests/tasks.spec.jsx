...
test('menu of edition of task', async({ page }) => {
  ...
  await expect(page.locator(`div[role="combobox"]`).nth(1)).toBeVisible()
  await expect(page.locator(`input[name="title"]`)).toBeVisbile()
  await expect(page.locator(`textarea[name="content"]`)).toBeVisible()
  await expect(page.locator(`div[role="combobox"]`).nth(2)).toBeVisible()
  await expect(page.locator(`div[role="combobox"]`).nth(3)).toBeVisible()
