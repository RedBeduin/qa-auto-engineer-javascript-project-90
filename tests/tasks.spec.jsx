...
test('menu of edition of task', async({ page }) => {
  ...
  await expect(page.locator(`combobox[aria-label="Assignee"]`)).toBeVisible()
  await expect(page.locator(`input[name="Title"]`)).toBeVisbile()
  await expect(page.locator(`input[name="Content"]`)).toBeVisible()
  await expect(page.locator(`combobox[aria-label="Status"]`)).toBeVisible()
  await expect(page.locator(`combobox[aria-label="Label"]`)).toBeVisible()
