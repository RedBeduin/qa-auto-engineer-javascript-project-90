...
test("login", async ({ page }) => {
  ...
  await expect(this.page.locator(`text="Lorem ipsum sic dolor amet..."`)).toBeVisible()
})
...
test("negative - login", async ({ page }) => {
  ...
  await expect(this.page.locator(`text="${textVault.errorTextLoginPage}"`)).toBeVisible()
...
test("create user", async ({ page }) => {
  ...
  await expect(this.page.locator(`text="Element created"`)).toBeVisible()
  await expect(this.page.locator(`text="email@gmail.com"`)).toBeVisible() 
  await expect(this.page.locator(`text="${textVault.userFirstName}"`)).toBeVisible()
  await expect(this.page.locator(`text="${textVault.userLastName}"`)).toBeVisible()
  await expect(this.page.locator(`[aria-label="Show"]`)).toBeVisible()
  ...
  await expect(this.page.locator(`text="${textVault.userFirstName}"`)).toBeVisible()
  await expect(this.page.locator(`text="${textVault.userLastName}"`)).toBeVisible()
  await expect(this.page.locator(`[aria-label="Edit"]`)).toBeVisible()
  await usersPage.navigateToUsersPage()  
  await expect(this.page.locator(`text="email@gmail.com"`)).toBeVisible()
  await expect(this.page.locator(`text="${textVault.userFirstName}"`)).toBeVisible()
  await expect(this.page.locator(`text="${textVault.userLastName}"`)).toBeVisible() 
...
test("user list", async ({ page }) => {
  ...
  {
    await expect(this.page.locator(`text="${user.Email}"`)).toBeVisible()
    await expect(this.page.locator(`text="${user.FirstName}"`)).toBeVisible()
    await expect(this.page.locator(`text="${user.LastName}"`)).toBeVisible()
  }
})
...
test("editing form", async ({ page }) => {
  ...
  await expect(this.page.locator(`text="${users[0].Email}"`)).toBeVisible()
  await expect(this.page.locator(`text="${users[0].FirstName}"`)).toBeVisible()
  await expect(this.page.locator(`text="${users[0].LastName}"`)).toBeVisible()
  await expect(this.page.locator(`[aria-label="Show"]`)).toBeVisible()
  await expect(this.page.locator(`[disabled][aria-labels="Save"]`)).toBeVisible()
  await expect(this.page.locator(`[aria-label="Delete"]`)).toBeVisible()
})
...
test("edit user", async ({ page }) => {
  ...
  await expect(this.page.locator(`text="${users[0].LastName}"`)).toBeVisible()
  await expect(this.page.locator(`text="${users[0].FirstName}"`)).not.toBeVisible()  
})
...
test("edit user from create form", async ({ page }) => {
  ...
  await usersPage.navigateToUsersPage()
  await expect(this.page.locator(`text="useremail@gmail.com"`)).toBeVisible()
  await expect(this.page.locator(`text="ChangedFirstName"`)).toBeVisible()
  await expect(this.page.locator(`text="${textVault.userLastName}"`)).toBeVisible()
  await expect(this.page.locator(`text="${textVault.userFirstName}"`)).not.toBeVisible() 
})
...
test("delete user", async ({ page }) => {
  ...
  await usersPage.navigateToUsersPage()
  await expect(this.page.locator(`text="${users[0].Email}"`)).not.toBeVisible()
  await expect(this.page.locator(`text="${users[0].FirstName}"`)).not.toBeVisible()
  await expect(this.page.locator(`text="${users[0].LastName}"`)).not.toBeVisible()
})
...
test("delete all user", async ({ page }) => {
  ...
  await usersPage.navigateToUsersPage()
  await expect(this.page.locator(`text="No Users yet."`)).toBeVisible()
})
