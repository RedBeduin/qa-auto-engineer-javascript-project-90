...
test("negative - login", async ({ page }) => {
  ...
  await expect(`text="${textVault.errorTextLoginPage}"`).toBeVisible()
...
test("create user", async ({ page }) => {
  ...
  await expect(`text="${textVault.userFirstName}"`).toBeVisible()
  await expect(`text="${textVault.userLastName}"`).toBeVisible()
...
test("edit user from create form", async ({ page }) => {
  ...
  await expect(`text="ChangedFirstName"`).toBeVisible()
  await expect(`text="${textVault.userLastName}"`).toBeVisible()
  await expect(`text="${textVault.userFirstName}"`).not.toBeVisible() 
})
